...
protected:
    void Draw() {
        ...
        _tOwnerLabel.backcolor = backcolor;
        _tOwnerLabel.fontcolor = fontcolor;
        _tGroupLabel.backcolor = backcolor;
        _tGroupLabel.fontcolor = fontcolor;
