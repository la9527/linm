...
namespace MLS {
    ...
    public:
        RtStateInfo() {
            nStatInfo = OPER_NONE;
            nCount = llCurBytes = llAllBytes = 0;
        }
    ...
    public:
        ...
        virtual int Copy(File &tFile,
                         const string &sTargetName,
                         File *pFile = NULL,
                         RtStateInfo * /*pRtInfo*/ = NULL) {
            return -1;
        }

        virtual int Move(File & /*tFile*/,
        ...
        virtual int Remove(File & /*tFile*/, RtStateInfo * /*pRtInfo*/ = NULL) {
            return -1;
        }

        virtual int Paste(File & /*tFile*/, RtStateInfo * /*pRtInfo*/ = NULL) {
            return -1;
        }
        ...
        void setProgress(CommonProgress *pProgress) { _pProgress = pProgress; }

    protected:
        CommonProgress *_pProgress;
