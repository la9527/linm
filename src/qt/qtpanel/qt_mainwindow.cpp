...
Qt_Panel *Qt_MainWindow::GetFocusPanel() {
    _pCentralMain->GetFocusPanel();
}

Qt_Mcd *Qt_MainWindow::GetFocusMcd() {
    _pCentralMain->GetFocusMcd();
}
...
void Qt_MainWindow::MenuDraw() {
    ...
    files.AddItem("filenew", _("&New"), "Cmd_NewFile", true);
    files.AddItem("", _("Touch File"), "Cmd_TouchFile", true);
    files.AddItem("", "", "");
    files.AddItem("", _("FileInfo"), "Cmd_FileInfo");
    files.AddItem("", "", "");
    files.AddItem("exit", _("&Quit LinM"), "Cmd_Quit", true);
    tMenu.AddCategory(files);

    MenuCategory edit(_("&Edit"));
    edit.AddItem("", "", "");
    edit.AddItem("editcut", _("ClipCut"), "Cmd_ClipCut", true);
    edit.AddItem("editcopy", _("ClipCopy"), "Cmd_ClipCopy", true);
    edit.AddItem("editpaste", _("ClipPaste"), "Cmd_ClipPaste", true);
    edit.AddItem("", "", "");
    edit.AddItem("", _("Select &All"), "Cmd_SelectAll");
    edit.AddItem("", _("&Invert select"), "Cmd_SelectInvert");
    edit.AddItem("", "", "");
    edit.AddItem("editcopy", _("Copy"), "Cmd_Copy");
    edit.AddItem("move", _("Move"), "Cmd_Move");
    edit.AddItem("rename", _("Rename"), "Cmd_Rename");
    edit.AddItem("remove", _("Delete"), "Cmd_Remove");
    edit.AddItem("", "", "");
    edit.AddItem("filefind", _("&Find"), "Cmd_FileFind");
    edit.AddItem("diff", _("Diff"), "Cmd_Diff");
    edit.AddItem("", "", "");
    ...
    dire.AddItem("up", _("To parent"), "Cmd_GoParent", true);
    dire.AddItem("", _("To root"), "Cmd_GoRoot");
    dire.AddItem("gohome", _("To home"), "Cmd_GoHome", true);
    dire.AddItem("", "", "");
    dire.AddItem("back", _("&Back"), "Cmd_Back", true);
    dire.AddItem("forward", _("&Forward"), "Cmd_Forward", true);

    tMenu.AddCategory(dire);

    MenuCategory run(_("&Run"));
    run.AddItem("exec", _("&Run"), "Cmd_Enter");
    run.AddItem("exec", _("Run(select)"), "Cmd_Execute");
    run.AddItem("", "", "");
    ...
    util.AddItem("connect_creating", _("&Remote Connect"), "Cmd_RemoteConnProps");
    util.AddItem("connect_creating", _("&Quick Connect"), "Cmd_RemoteConnect");
    util.AddItem("connect_no", _("&Disconnect"), "Cmd_RemoteClose");
    util.AddItem("", "", "");
    util.AddItem("", _("&Extract"), "Cmd_Extract");
    util.AddItem("", "", "");
    util.AddItem("tgz", _("Compress (tar.gz)"), "Cmd_TargzComp");
    util.AddItem("tgz", _("Compress (tar.bz2)"), "Cmd_Tarbz2Comp");
    util.AddItem("zip", _("Compress (zip)"), "Cmd_ZipComp");
    tMenu.AddCategory(util);

    MenuCategory view(_("&View"));
    view.AddItem("reload", _("&Refresh"), "Cmd_Refresh");
    view.AddItem("", "", "");
    ...
    mls.AddItem("", "", "");
    mls.AddItem("help", _("&Help"), "Cmd_Help");
