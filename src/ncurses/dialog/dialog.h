...
class Form
{
	...
	protected:
		...
		bool		_bExit;
		bool		_bNotDrawBox;
		bool		_bNoOutRefresh; // internal use refresh
		bool		_bNoViewUpdate; // use screen update
		string		_sTitle;
...
public:
	...
	int		nNextLineNum;	/// next line position of over one line
	bool	bNext;			/// Is it over one line.
