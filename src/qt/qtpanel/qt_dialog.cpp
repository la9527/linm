...
void Qt_Dialog::MsgBox(const string &sTitle, const string &sMsg) {
    ...
    QMessageBox::critical(_pWidget, QObject::tr(sTitle.c_str()), QObject::tr(sMsg.c_str()));
}
...
#ifdef    LINM_KDE
    return SmallIconSet( strIconName );
#else
...
QColor LinMGlobal::GetColor(int nNum) {
    ...
    switch (nNum) {
        case 0:
            return Qt::black;
        case 1:
            return QColor(100, 0, 0); //Qt::darkRed;
        case 2:
            return QColor(30, 80, 0);
        case 3:
            return QColor(152, 0, 0);    // 갈색
        case 4:
            return Qt::darkBlue;
        case 5:
            return QColor(110, 2, 120);
        case 6:
            return QColor(200, 0, 0);    // 청록
        case 7:
        ...
        case 11:
            return Qt::yellow;
        case 12:
            return QColor(0, 55, 165);
        case 13:
            return QColor(119, 7, 129);
        case 14:
            return Qt::blue;
        case 15:
            return Qt::white;
