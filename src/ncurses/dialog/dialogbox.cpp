...
Curses_MsgBox(const string &sTitle, const string &sMsg) : Form() {
    ...
    _tButton.backcolor = backcolor;
    _tButton.fontcolor = fontcolor;
    _tLabel.backcolor = backcolor;
    _tLabel.fontcolor = fontcolor;
}
...
Curses_YNBox(const string &sTitle, const string &sMsg, bool bYes) : Form() {
    ...
    _tButtonOk.backcolor = backcolor;
    _tButtonOk.fontcolor = fontcolor;
    _tButtonCancel.backcolor = backcolor;
    _tButtonCancel.fontcolor = fontcolor;
    _tLabel.backcolor = backcolor;
    _tLabel.fontcolor = fontcolor;
...
Curses_ProgressBox::Curses_ProgressBox() : Form() {
    _bDouble = false;
    _bExit = false;
    ...
    _tLabelUpLeft = Label("");
    _tLabelUpRight = Label("");
    _tLabelDnLeft = Label("");
    _tLabelDnRight = Label("");
...
void Curses_ProgressBox::setOneValue(int nCnt) {
    _nCnt = nCnt;
}

void Curses_ProgressBox::setTwoValue(int nCnt) {
    _nCnt2 = nCnt;
}
...
Curses_TextBox(const string &sTitle) : Form() {
    ...
    _tButton.backcolor = backcolor;
    _tButton.fontcolor = fontcolor;
    _tTextBox.backcolor = backcolor;
    _tTextBox.fontcolor = fontcolor;
    _bESC = false;
}
