...
void	PasswdCrypt::DesECBEncode(const string& sKeyHex, const string& sDecode, string& sEncode)
{
	...
	DES_set_key(&tHexBlock, &tKeySchedule);
	DES_ecb_encrypt(&tSrcBlock, &tDecBlock, &tKeySchedule, DES_ENCRYPT);
...
void	PasswdCrypt::DesECBDecode(const string& sKeyHex, const string& sEncode, string& sDecode)
{
	...
	DES_set_key(&tKeyBlock, &tKeySchedule);
	DES_ecb_encrypt(&tEncBlock, &tDecBlock, &tKeySchedule, DES_DECRYPT);
